export default {
  ...
  'corporate.name': '2018 中國圖書進出口(集團)總公司',
  'component.globalHeader.search': '站內搜索',
  'component.globalHeader.help': '使用幫助',
  ...
  'menu.workplace': '工作臺',
  'menu.agency': '機構管理',
  'menu.agency.list': '機構管理',
  'menu.agency.info': '機構詳細',
  'menu.agency.resource': '資源分配',
  'menu.course': '課程管理',
  'menu.course.video': '視頻課程',
  'menu.course.online': '在線課程',
  'menu.material': '教材管理',
  'menu.material.electron': '電子教材',
  'menu.material.world': '閱讀世界',
  'menu.train': '培訓管理',
  'menu.package': '套餐產品',
  'menu.authority': '權限管理',
  ...
  'app.more': '更多',
  'app.disabled': '禁用',
  'app.please.select': '請選擇',
  'app.please.enter': '請輸入',
  'app.authority.user.create.modal.title': '新建用戶',
  'app.authority.user.create.modal.ok': '創建',
  'app.authority.user.organization': '機構',
  'app.authority.user.role': '角色',
  'app.authority.user.name': '姓名',
  'app.authority.user.account': '賬號',
  'app.authority.user.password': '密碼',
  'app.authority.user.phone': '手機',
  'app.authority.user.email': '郵箱',
  'app.authority.user.status': '狀態',
  'app.authority.user.enable': '啟用',
  'app.authority.user.disable': '禁用',
  'app.authority.user.lastLoginTime': '最後登錄時間',
  'app.authority.user.operating': '操作',

  'app.authority.user.account.error.length': '賬號必須為4-16位',
  'app.authority.user.account.error.type': '用戶名必須為字母或者數字',
  'app.authority.user.password.error.length': '密碼必須為6-20位',
  'app.authority.user.phone.error.format': '手機號格式錯誤',
  'app.authority.user.email.error.format': '郵箱格式錯誤',

  'app.authority.user.msg.notOptions': '沒有找到選項',
  'app.authority.user.msg.delete': '位用戶被選擇,確認要刪除嗎?',
